...
SUB    = ["「じぶんで はく」が はじまる えほん", "1さい 2さい 3さい"]
AUTHOR = "さく・え　はりま せいじ"

BLURB_A = ["パンツは かって あるのに、", "「おむつが いい」と いう。"]
BLURB_B = ["いちばん むずかしいのは", "「はく こと」じゃなくて、", "「じぶんで きめる こと」。"]
BLURB_C = ["・たいしょう 1さい 2さい 3さい", "・よみきかせ 3〜4ふん"]
