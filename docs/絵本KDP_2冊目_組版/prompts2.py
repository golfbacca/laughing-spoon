...
- ONE small round woven basket, used as the waste basket. It stands on
  the OPEN FLOOR at the FAR LEFT of the picture, clear of the shelf and
  beyond its left-hand leg - never in between the legs, never underneath
  the shelf, never tucked under any furniture. It is the leftmost object
  in the room. There is only one basket in the whole room.
