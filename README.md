...
- 1・2セット目とも Creators Market から審査リクエスト済み
...
| 時期 | やること |
|---|---|
| 承認メールが来たら | **押さない。** 8/31 11:00 までは販売開始を押さない（特集の新着欄から外れる） |
| 8/31 11:00 〜 | 販売開始を押す。10/12 10:59 までに押さないと非公開のまま |
| 販売開始後 | 自分でオープンチャットで使う。どの番号が一番送られたか記録する |
| 10/13 以降 | 特集終了。反応を見て3セット目の方向を決める |
